...
Derma_Hook( FLOOD_PANEL, 	"Paint", 				"Paint", 	"GameNotice" )
Derma_Hook( FLOOD_PANEL, 	"ApplySchemeSettings", 	"Scheme", 	"GameNotice" )
Derma_Hook( FLOOD_PANEL, 	"PerformLayout", 		"Layout", 	"GameNotice" )

function FLOOD_PANEL:Init()
...
function FLOOD_PANEL:AddEntityText( txt )
...
function FLOOD_PANEL:AddItem( item )
	table.insert( self.Items, item )
	self:InvalidateLayout( true )
end

function FLOOD_PANEL:AddText( txt, color )
...
function FLOOD_PANEL:AddIcon( txt )
...
function FLOOD_PANEL:PerformLayout()
...
derma.DefineControl( "GameNotice", "", FLOOD_PANEL, "DPanel" )